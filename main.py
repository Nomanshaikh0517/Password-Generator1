...
length = Label(root, text="Select the Length of Your Password ", fg="darkgreen", bg="white", font=("ubuntu", 12))
length.place(x="80px", y="50px")
...
Selector.current(7)
Selector.place(x="130px", y="72px")

generate_btn = Button(root, text="Generate Password", bg="orange", fg="black", font=("ubuntu", 11), cursor="hand2", command=password_generate)
generate_btn.bind("<Enter>", on_enter)
generate_btn.bind("<Leave>", on_leave)
generate_btn.pack(anchor="center", pady="50px")
generate_btn.place(x="130px",y="130")

result_lable = Label(root, text="Generated Password Here", bg="white", fg="darkgreen", font=("ubuntu", 12))
result_lable.place(x="90px", y="140px")

password = StringVar()
password_final = Entry(root, textvariable= password, state="readonly", fg="black", font=("ubuntu", 15))
password_final.place(x="90px", y="170px")
